...
export default function Home() {
  ...
  👋 Chào mừng trở lại, <span className="text-green-600 dark:text-green-400">Đức Anh</span> !!!
</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {forecast.map((day) => {
              ...
              return (
                <div
                  key={day.date}
                  className="flex items-center gap-4 border rounded-lg p-3 bg-card text-card-foreground shadow-sm"
                >
                  <img
